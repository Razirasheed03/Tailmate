...
export default function PetProfiles() {
  ...
  // deletion state (replaces window.confirm)
  ...
  const saveEdit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast(e?.message || 'Failed to update pet');
    } finally {
      setSaving(false);
    }
  };

  // deletion flow without window.confirm
  ...
  const performDelete = async (id: string) => {
    ...
    try {
      ...
      toast(e?.message || 'Failed to delete pet');
    } finally {
      setRemovingId(null);
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
        <p className="text-sm text-gray-700">View, edit, and delete pet profiles.</p>
      </div>
