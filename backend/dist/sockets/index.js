...
function initializeSocketServer(io) {
    ...
    io.on("connection", (socket) => {
        ...
        socket.on("consultation:join", (data) => __awaiter(this, void 0, void 0, function* () {
            try {
                // Access service through DI controller (private property, use any cast)
                const consultation = yield consultation_di_1.consultationController.service.getConsultation(data.consultationId);
        ...
        socket.on("chat:send_message", (data) => __awaiter(this, void 0, void 0, function* () {
            try {
                const message = yield chat_di_1.chatController.service.sendMessage(userId, data.roomId, data.content);
        ...
        socket.on("chat:mark_seen", (data) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield chat_di_1.chatController.service.markSeen(userId, data.roomId);
