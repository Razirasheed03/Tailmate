...
class AuthService {
    constructor(_userRepo) {
        ...
        this.signup = (user) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield redisClient_1.default.setEx(key, 300, JSON.stringify(Object.assign(Object.assign({}, user), { password: hashedPassword, isAdmin: false, isDoctor: !!user.isDoctor, isBlocked: false, otp, createdAt })));
