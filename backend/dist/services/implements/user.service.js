...
class UserService {
    constructor(_userRepo = new user_repository_1.UserRepository(), _doctorPubRepo = new doctorPublic_repository_1.DoctorPublicRepository(), _bookingRepo = new booking_repository_1.BookingRepository()) {
