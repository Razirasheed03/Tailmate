...
class ChatService {
    constructor(chatRepo = new chat_repository_1.ChatRepository(), messageRepo = new message_repository_1.MessageRepository(), matchmakingRepo = new matchmaking_repository_1.MatchmakingRepository()) {
    ...
    markSeen(currentUserId, roomId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.messageRepo.markSeen(roomId, currentUserId);
            return { success: true };
        });
    }
}
