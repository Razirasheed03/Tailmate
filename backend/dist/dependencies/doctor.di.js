...
exports.doctorController = new doctor_controller_1.DoctorController(new doctor_service_1.DoctorService(new user_repository_1.UserRepository(), new doctor_repository_1.DoctorRepository()));
