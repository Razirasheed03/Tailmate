...
class CheckoutController {
    constructor(svc) {
        this.svc = svc;
        this.getQuote = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                const uid = ((_b = (_a = req.user) === null || _a === void 0 ? void 0 : _a._id) === null || _b === void 0 ? void 0 : _b.toString()) || ((_c = req.user) === null || _c === void 0 ? void 0 : _c.id);
                if (!uid) {
                    return ResponseHelper_1.ResponseHelper.unauthorized(res, messageConstant_1.HttpResponse.UNAUTHORIZED);
                }
                const payload = req.body || {};
                const data = yield this.svc.getQuote(uid, payload);
        ...
        this.createCheckout = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                const uid = ((_b = (_a = req.user) === null || _a === void 0 ? void 0 : _a._id) === null || _b === void 0 ? void 0 : _b.toString()) || ((_c = req.user) === null || _c === void 0 ? void 0 : _c.id);
                if (!uid) {
                ...
                const payload = req.body || {};
                const data = yield this.svc.createCheckout(uid, payload);
