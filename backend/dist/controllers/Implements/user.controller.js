...
exports.getVetDetail = getVetDetail;
exports.getVetSlots = getVetSlots;
...
function updateMyProfile(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const user = yield service.updateMyUsername(uid, username);
...
function listDoctors(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const result = yield service.listDoctorsWithNextSlot({
                page,
                limit,
                search,
                specialty,
...
function getVetDetail(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const id = String(req.params.id || "").trim();
            if (!id)
                return ResponseHelper_1.ResponseHelper.badRequest(res, "id is required");
            const data = yield service.getDoctorPublicById(id);
            if (!data)
...
function getVetSlots(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const id = String(req.params.id || "").trim();
            ...
            const data = yield service.listDoctorGeneratedAvailability(id, {
                from,
                to,
            });
            return ResponseHelper_1.ResponseHelper.ok(res, data, messageConstant_1.HttpResponse.RESOURCE_FOUND);
...
function listMyBookings(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const data = yield service.listMyBookings(userId, {
                page,
                limit,
                scope,
                status,
...
function getMyBooking(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b;
        try {
            const userId = (_b = (_a = req.user) === null || _a === void 0 ? void 0 : _a._id) === null || _b === void 0 ? void 0 : _b.toString();
            ...
            const booking = yield service.getMyBookingById(userId, bookingId);
            if (!booking) {
...
function cancelMyBooking(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const result = yield service.cancelMyBooking(userId, bookingId);
            if (!result.success) {
...
function getMyWalletTransactions(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b;
        try {
            const userId = (_b = (_a = req === null || req === void 0 ? void 0 : req.user) === null || _a === void 0 ? void 0 : _a._id) === null || _b === void 0 ? void 0 : _b.toString();
