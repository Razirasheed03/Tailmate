...
const svc = new consultation_service_1.ConsultationService();
    ...
    constructor() {
        this.create = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const consultation = yield svc.create(userId, doctorId, req.body || {});
        ...
        this.getConsultation = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const consultation = yield svc.getConsultation(id);
        ...
        this.getUserConsultations = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const consultations = yield svc.getUserConsultations(userId, status);
        ...
        this.getDoctorConsultations = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const status = req.query.status || undefined;
                const consultations = yield svc.getDoctorConsultations(doctorId, status);
                return ResponseHelper_1.ResponseHelper.ok(res, consultations, messageConstant_1.HttpResponse.RESOURCE_FOUND);
            }
            catch (err) {
                next(err);
        ...
        this.prepareCall = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const result = yield svc.prepareConsultationCall(id, userId, doctorId, role);
        ...
        this.endCall = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const { id } = req.params;
                const consultation = yield svc.endConsultationCall(id, userId);
        ...
        this.cancel = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const consultation = yield svc.cancelConsultation(id, userId, reason || "");
        ...
        this.getOrCreateFromBooking = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const consultation = yield svc.getOrCreateConsultationFromBooking(bookingId, patientId, // Use patientId from booking, not from JWT
